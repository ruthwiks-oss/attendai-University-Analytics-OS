...
const sectionDetails: Record<string, { eyebrow: string; title: string; description: string; rows: string[]; action: string }> = {
  ...
  "AI Predictions": { eyebrow: "BASELINE ANALYTICS / TIMESTAMPED", title: "AI risk signals", description: "Explainable attendance projections ready for human intervention.", rows: ["126 students need attention", "Average predicted attendance · 74.6%", "3 significant attendance declines this week"], action: "Generate predictions" },
  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      <div className="page-wrap">
        ...
        <section className="insight-banner"><div className="insight-icon"><Sparkles size={21} /></div><div><span>AI INSIGHT</span><p>Attendance is trending <strong>+6.2%</strong> this month. <strong>126 students</strong> may need early intervention.</p></div><button onClick={() => openSection("AI Predictions")}>View insights <ArrowUpRight size={15} /></button></section>
